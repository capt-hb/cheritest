...
# %bb.0:                                # %entry
	...
	ucsc	$c11, $c1, 0($c11)    # 32-byte Folded Spill
	ucsc	$c11, $c3, 0($c11)    # 32-byte Folded Spill
	ucsc	$c11, $c4, 0($c11)    # 32-byte Folded Spill
	b	.LBB1_1
	nop
.LBB1_1:                                # %for.cond
...
# %bb.0:                                # %entry
	...
	ucsw	$c11, $zero, 0($c11)
	csetbounds $c5, $c11, 4
	ucsw	$c11, $1, 0($c11)    # 4-byte Folded Spill

	ucsd $c11, $zero, 0($c11)
	ucsd $c11, $zero, 0($c11)

	ucsc	$c11, $c1, 0($c11)   # 32-byte Folded Spill
	ucsc	$c11, $c2, 0($c11)    # 32-byte Folded Spill
	ucsc	$c11, $c4, 0($c11)    # 32-byte Folded Spill
	ucsc	$c11, $c5, 0($c11)    # 32-byte Folded Spill
	b	.LBB2_1
	nop
.LBB2_1:                                # %for.cond
                                        # =>This Inner Loop Header: Depth=1
